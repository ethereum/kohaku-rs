...
pub const SETTLE_FRAME_GAS: u64 = 1_400_000;
pub const SETTLE_FRAME_STATE_GAS: u64 = 550_000;
pub const CLAIM_FRAME_GAS: u64 = 500_000;
pub const CLAIM_FRAME_STATE_GAS: u64 = 200_000;
pub const EXECUTE_FRAME_GAS: u64 = 500_000;
pub const EXECUTE_FRAME_STATE_GAS: u64 = 100_000;
pub const SHIELD_VERIFY_GAS: u64 = 80_000;
pub const SIGNATURE_GAS_SECP256K1: u64 = 2_800;
pub const ENSURE_AND_CLAIM_CALLDATA: usize = 132;
